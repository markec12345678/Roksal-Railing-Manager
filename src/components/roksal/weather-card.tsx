...
export function WeatherCard({
  ...
  return (
    <Card className="overflow-hidden border-l-4 border-l-sky-500/70 transition-all duration-200 card-hover">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="flex items-center gap-2 text-[11px] text-muted-foreground">
                  ...
                  <span className="inline-flex items-center gap-0.5">
                    <Gauge className="h-3 w-3" /> {weather.pressure} hPa
                  </span>
                </p>
              </div>
              {/* Veterni kompas */}
            ...
            <div className="flex items-start gap-2 rounded-lg bg-muted/40 p-2.5">
              ...
              <p className="text-[11px] leading-snug text-muted-foreground">
                ...
                {weather.maxRailingHeight > 0 && (
                  <> Največja varna višina ograje: <strong>{(weather.maxRailingHeight / 1000).toFixed(1)} m</strong>.</>
                )}
              </p>
            </div>
          </div>
