...
| Testi (vitest) | **1533** (87 datotek, vključno z globalSetup embedded PG) |
...
| **Testiranje** | [Vitest 4](https://vitest.dev/) (1533 testov + globalSetup embedded PG) |
...
| `bun run test` | Vsi testi (vitest, 1533, embedded PG prek globalSetup) |
