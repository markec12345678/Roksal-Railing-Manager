...
| Testi (vitest) | **1001** (63 datotek, vključno z globalSetup embedded PG) |
| Varnostni smoke | 139 preverjanj na zagnanem strežniku (`tools/security-smoke.py`, del pogojno) |
...
| `bun run smoke` | Varnostni smoke na zagnanem strežniku (139 preverjanj) |
