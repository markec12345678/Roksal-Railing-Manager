...
| Testi (vitest) | **1631** (93 datotek, vključno z globalSetup embedded PG) |
...
| **Testiranje** | [Vitest 4](https://vitest.dev/) (1631 testov + globalSetup embedded PG) |
...
| `bun run test` | Vsi testi (vitest, 1631, embedded PG prek globalSetup) |
