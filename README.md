...
| Testi (vitest) | **1420** (82 datotek, vključno z globalSetup embedded PG) |
...
| **Testiranje** | [Vitest 4](https://vitest.dev/) (1420 testov + globalSetup embedded PG) |
...
| `bun run test` | Vsi testi (vitest, 1420, embedded PG prek globalSetup) |
