...
| Testi (vitest) | **967** (62 datotek, vključno z globalSetup embedded PG) |
| Varnostni smoke | 137 preverjanj na zagnanem strežniku (`tools/security-smoke.py`, del pogojno) |
...
| `bun run smoke` | Varnostni smoke na zagnanem strežniku (137 preverjanj) |
