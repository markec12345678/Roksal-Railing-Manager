...
| Testi (vitest) | **1591** (91 datotek, vključno z globalSetup embedded PG) |
...
| **Testiranje** | [Vitest 4](https://vitest.dev/) (1591 testov + globalSetup embedded PG) |
...
| `bun run test` | Vsi testi (vitest, 1591, embedded PG prek globalSetup) |
