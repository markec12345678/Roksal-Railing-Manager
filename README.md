...
| Testi (vitest) | **1673** (95 datotek, vključno z globalSetup embedded PG) |
...
| **Testiranje** | [Vitest 4](https://vitest.dev/) (1673 testov + globalSetup embedded PG) |
...
| `bun run test` | Vsi testi (vitest, 1673, embedded PG prek globalSetup) |
