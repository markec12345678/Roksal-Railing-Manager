...
| Varnostni smoke | 100 preverjanj na zagnanem strežniku (`tools/security-smoke.py`, del pogojno) |
...
| `bun run smoke` | Varnostni smoke na zagnanem strežniku (100 preverjanj) |
