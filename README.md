...
| Testi (vitest) | **1446** (83 datotek, vključno z globalSetup embedded PG) |
...
| **Testiranje** | [Vitest 4](https://vitest.dev/) (1446 testov + globalSetup embedded PG) |
...
| `bun run test` | Vsi testi (vitest, 1446, embedded PG prek globalSetup) |
