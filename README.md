...
| Testi (vitest) | **1333** (79 datotek, vključno z globalSetup embedded PG) |
...
| **Testiranje** | [Vitest 4](https://vitest.dev/) (1333 testov + globalSetup embedded PG) |
...
| `bun run test` | Vsi testi (vitest, 1333, embedded PG prek globalSetup) |
