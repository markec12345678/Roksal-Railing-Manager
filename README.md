...
| Testi (vitest) | **1516** (86 datotek, vključno z globalSetup embedded PG) |
...
| **Testiranje** | [Vitest 4](https://vitest.dev/) (1516 testov + globalSetup embedded PG) |
...
| `bun run test` | Vsi testi (vitest, 1516, embedded PG prek globalSetup) |
