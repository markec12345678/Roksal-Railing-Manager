...
| Testi (vitest) | **1255** (77 datotek, vključno z globalSetup embedded PG) |
...
| **Testiranje** | [Vitest 4](https://vitest.dev/) (1255 testov + globalSetup embedded PG) |
...
| `bun run test` | Vsi testi (vitest, 1255, embedded PG prek globalSetup) |
