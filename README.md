...
| Testi (vitest) | **1572** (90 datotek, vključno z globalSetup embedded PG) |
...
| **Testiranje** | [Vitest 4](https://vitest.dev/) (1572 testov + globalSetup embedded PG) |
...
| `bun run test` | Vsi testi (vitest, 1572, embedded PG prek globalSetup) |
