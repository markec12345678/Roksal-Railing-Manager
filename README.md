...
| Testi (vitest) | **1377** (80 datotek, vključno z globalSetup embedded PG) |
...
| **Testiranje** | [Vitest 4](https://vitest.dev/) (1377 testov + globalSetup embedded PG) |
...
| `bun run test` | Vsi testi (vitest, 1377, embedded PG prek globalSetup) |
