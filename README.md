...
| Testi (vitest) | **1214** (76 datotek, vključno z globalSetup embedded PG) |
...
| **Testiranje** | [Vitest 4](https://vitest.dev/) (1214 testov + globalSetup embedded PG) |
...
| `bun run test` | Vsi testi (vitest, 1214, embedded PG prek globalSetup) |
