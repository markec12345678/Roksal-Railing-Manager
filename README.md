...
| Testi (vitest) | **1472** (84 datotek, vključno z globalSetup embedded PG) |
...
| **Testiranje** | [Vitest 4](https://vitest.dev/) (1472 testov + globalSetup embedded PG) |
...
| `bun run test` | Vsi testi (vitest, 1472, embedded PG prek globalSetup) |
