...
| Testi (vitest) | **1184** (75 datotek, vključno z globalSetup embedded PG) |
...
| **Testiranje** | [Vitest 4](https://vitest.dev/) (1184 testov + globalSetup embedded PG) |
...
| `bun run test` | Vsi testi (vitest, 1184, embedded PG prek globalSetup) |
