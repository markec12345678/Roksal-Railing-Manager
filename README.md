...
| Testi (vitest) | **1289** (78 datotek, vključno z globalSetup embedded PG) |
...
| **Testiranje** | [Vitest 4](https://vitest.dev/) (1289 testov + globalSetup embedded PG) |
...
| `bun run test` | Vsi testi (vitest, 1289, embedded PG prek globalSetup) |
