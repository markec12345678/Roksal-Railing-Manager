...
| Testi (vitest) | **1560** (89 datotek, vključno z globalSetup embedded PG) |
...
| **Testiranje** | [Vitest 4](https://vitest.dev/) (1560 testov + globalSetup embedded PG) |
...
| `bun run test` | Vsi testi (vitest, 1560, embedded PG prek globalSetup) |
