...
| Testi (vitest) | **1614** (92 datotek, vključno z globalSetup embedded PG) |
...
| **Testiranje** | [Vitest 4](https://vitest.dev/) (1614 testov + globalSetup embedded PG) |
...
| `bun run test` | Vsi testi (vitest, 1614, embedded PG prek globalSetup) |
