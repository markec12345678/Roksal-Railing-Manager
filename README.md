...
| Testi (vitest) | **1547** (88 datotek, vključno z globalSetup embedded PG) |
...
| **Testiranje** | [Vitest 4](https://vitest.dev/) (1547 testov + globalSetup embedded PG) |
...
| `bun run test` | Vsi testi (vitest, 1547, embedded PG prek globalSetup) |
