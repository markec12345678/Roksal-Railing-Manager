#!/bin/bash
# R173 mikro-probe: Logistika chunk regresija (R169 needle 'Vsota predvidenih ur vidnih terminov').
# Razlog: r173-prod-qa.sh ni obiskal Logistike → chunk-24 ni bil zbran → needle NIČ je
