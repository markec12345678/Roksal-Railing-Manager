#!/bin/bash
# R160 dimni: svež proces (nauček R140 — 429 je stanje procesa), 143 preverjanj.
...
setsid node .next/standalone/server.js > /tmp/r160-server-smoke.log 2>&1 < /dev/null &
sleep 4

echo "--- dimni [1..35] (143 preverjanj) ---"
