// R180 — E2E priprava: dev-only portal žeton (roksal_dev @ localhost:5433).
// Izbere NAJSTAREJŠI projekt in mu omogoči portal z determinističnim žetonom
// 'r180-qa-portal-zeton' (≥ MIN_TOKEN_LENGTH=8). Samo lokalni dev — produkcija
// NI dotaknjena (red line: žeton obstaja samo v roksal_dev).
import { PrismaClient } from '@prisma/client'

const prisma = new PrismaClient()
const TOKEN = 'r180-qa-portal-zeton'
